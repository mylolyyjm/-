<template>
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			...
			<el-col :span="4">
				<el-tooltip class="item tip-logout" effect="dark blue" content="退出" placement="bottom" style="padding:0px;">
		...
		<el-col :span="24" class="panel-center">
			<aside style="width:230px;">
				<h5 class="admin"><i class="fa fa-user" aria-hidden="true" style="margin-right:5px;"></i>欢迎系统用户：{{currentUser}}</h5>
			...
			<section class="panel-c-c">
				<div class="grid-content bg-purple-light">
					<el-col :span="24" style="padding: 0 0px">
...
<script>
	...
	export default {
		mounted() {
			var _this = this;
			_this.currentUser = cookie.GetCookieValue('user');
			var userCookie = cookie.GetCookieValue('user');
			console.log(userCookie);
		},
		data() {
			return {
				currentPath: '/Alldevice',
				currentPathName:'全部设备',
				currentPathNameParent:'设备管理',
				currentUser:'',
				form: {
					name: '',
					region: '',
